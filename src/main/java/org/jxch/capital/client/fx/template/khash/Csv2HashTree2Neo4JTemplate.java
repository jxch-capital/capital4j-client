...
import org.jxch.capital.client.fx.dto.Csv2HashTree2Neo4JParam;
...
@ParentTemplateService(templateParamType = Csv2HashTree2Neo4JParam.class)
public class Csv2HashTree2Neo4JTemplate implements KHashParentTemplate{
    ...
    public Parent template(String templateParam, String scriptParam) {
        Csv2HashTree2Neo4JParam param = JSON.parseObject(templateParam, Csv2HashTree2Neo4JParam.class);
